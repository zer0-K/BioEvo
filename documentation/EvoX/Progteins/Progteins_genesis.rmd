...
If list size!=0:
    ...
    CALL RNAP 
    CALL ribosome
    get back func ID for genetic marker
    decrease stack ptr to get old stack ptr
    increase stack ptr several times to get end of transcribed genes
    set stack ptr to old stack ptr
    decrease val at TOPS (i.e. list size)
    set x = pos after end of list
    write genetic marker (begin of func)
    set y = x + v where v is such that y is the first transcribed codon
    While y != end of transcribed genes
        data at x = data at y
    write genetic marker (end of func)
...
| id_tRNA_OPEcstcst, 0, 99, 3       // stck ptr += 3 (ptr to end of transcribed genes)
| id_tRNA_GTSLV, 2                  // var 2 <- end of transcribed genes
...
| id_tRNA_GTSLV, 1                  // var 1 <- ptr to shift transcribed genes
| id_tRNA_SDLVcst, 1, instruction::MARKER // genetic marker (begin)
| id_tRNA_INCLV, 0, 1
| id_tRNA_SDLVcst, 1, 0
| id_tRNA_INCLV, 0, 1
| id_tRNA_SDLVLV, 1, 3 
...
| id_tRNA_INCLV, 0, 1
| id_tRNA_SDLVcst, 1, 0
| id_tRNA_INCLV, 0, 1               // genetic marker (begin)
| id_tRNA_SLVLV, 5, 1               
...
| id_tRNA_SWJ
|
| id_tRNA_SDLVcst, 1, instruction::MARKER // genetic marker (end)
| id_tRNA_INCLV, 0, 1
| id_tRNA_SDLVcst, 1, 0
| id_tRNA_INCLV, 0, 1
| id_tRNA_SDLVLV, 1, 3 
...
| id_tRNA_INCLV, 0, 1
| id_tRNA_SDLVcst, 1, 0
| id_tRNA_INCLV, 0, 1               // genetic marker (end)
