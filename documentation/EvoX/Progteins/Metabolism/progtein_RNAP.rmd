...
| id_tRNA_RGLVLV, 2, 1            // var2 <- body val at var1
| id_tRNA_SLVcst, 5, GSTART_ID-1  // var5 <- GSTART_ID-1 (to avoid meta-ID capture)
| id_tRNA_INCLV, 0, 5             // var5++
| id_tRNA_CMPLVLV, 0, 5, 2, 5     // var5 <- var5==var2 (if we are at the beginning of a gene)
| id_tRNA_IF0, 5
| | id_tRNA_INCLV, 0, 1             // var1++
| | id_tRNA_RGLVLV, 2, 1            // var2 <- body val at var1
...
| id_tRNA_SLVcst, 5, GSTOP_ID-1  // var5 <- GSTART_ID-1
| id_tRNA_INCLV, 0, 5             // var5++
| id_tRNA_SLVDLV, 3, 2            // var3 <- *var2
| id_tRNA_CMPLVLV, 0, 3, 5, 3     // var3 <- var3==var5 (if we are at the end of the gene)
| id_tRNA_INCLV, 1, 3             // var3--
id_tRNA_SWJ
