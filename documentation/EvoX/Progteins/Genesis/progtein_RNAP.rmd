...
var 7 : for metamutator check
var 8 : for metamutator check
var 9 : for metamutator check
...
While loop var is not a gene stop
  ...
  skip metamutator if there is one
...
GSTART_ID, 207, id_tRNA_CVARS, LV_place, 10, id_tRNA_IVARS, id_tRNA_SLVcst,
...
0, 8, id_tRNA_CMPLVcst, 2, 7, 10000, 9, 
...
|
| id_tRNA_SLVLV, 7, 5                           // var7 <- var5
| id_tRNA_OPELVcst, 1, 7, id_begin_mutators     // var7 -= mutator_ids
| id_tRNA_CMPLVcst, 2, 7, 0, 8                  // var8 <- var 7 >= 0 ?
| id_tRNA_CMPLVcst, 1, 7, 10000, 9              // var9 <- var 7 < 10000 ?
| id_tRNA_OPELVLV, 2, 8, 9                      // var8 *= var9 (1 if mut <= var9 < mut+10k)
| id_tRNA_IF0, 8
| * metamutator found : skip *
|
| | *get metamutator size (next locus)*
| | id_tRNA_INCLV, 0, 1             // var1++
| | id_tRNA_RGLVLV, 5, 1            // var5 <- body val at var1 (metamutator size)
| | id_tRNA_OPELVLV, 0, 1, 5        // var1 += metamutator size
| | id_tRNA_INCLV, 1, 1             // var1-- (fencepost)
| | id_tRNA_INCLV, 1, 2             // var2-- (fencepost)
|
| id_tRNA_SIJ
|
