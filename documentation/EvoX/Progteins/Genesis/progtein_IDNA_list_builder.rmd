...
To find the DNA, the progtein loops through the molecular body, 
stops at each molecular marker and check if molecular ID is '-1' the ID corresponding to DNA.
...
If it finds a molecular marker with molecular ID '-1' it stops : end of DNA is reached.
