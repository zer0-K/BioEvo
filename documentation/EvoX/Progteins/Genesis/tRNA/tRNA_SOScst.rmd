---
title: Documentation of the SOScst tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA sets output size to constant value.


Arg : nothing
Output : code of the 'SOScst' amino acid
...
*write amino acid SETOS, 0, 0, 0, cst, 0, 0*
...
instruction::MARKER, 0, 11000, 0, 0, 0, 0,
