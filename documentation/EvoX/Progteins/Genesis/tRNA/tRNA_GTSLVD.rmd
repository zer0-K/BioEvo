---
title: Documentation of the GTSLVD tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that gets top of stack into a variable and decrement stack.


Arg : nothing
Output : code of the 'GTSLVD' amino acid
...
*write amino acid CPY, 1, 2, 0, var, 99, 0*
id_tRNA_MCPY
id_tRNA_M1
id_tRNA_M2
id_tRNA_M0
...
instruction::MARKER, 0, 10211, 0, 0, 0, 0,
