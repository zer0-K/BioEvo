---
title: Documentation of the generic instruction meta tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the meta RNA for an instruction.


Arg : nothing
Output : code of the 'meta instruction' amino acid
...
*write amino acid CPY, 3, 0, 0, 101, instruction, 0*
id_tRNA_MCPY
id_tRNA_M3
id_tRNA_M0
id_tRNA_M0
...
instruction::MARKER, 0, 14200, 0, 0, 0, 0,
