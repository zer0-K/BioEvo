---
title: Documentation of the SLVaddr tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that writes value at constant address into a variable.


Arg : nothing
Output : code of the 'SLVaddr' amino acid
...
*write amino acid CPY, 1, 1, 0, var, addr, 0*
id_tRNA_MCPY
id_tRNA_M1
id_tRNA_M1
id_tRNA_M0
...
instruction::MARKER, 0, 10115, 0, 0, 0, 0,
