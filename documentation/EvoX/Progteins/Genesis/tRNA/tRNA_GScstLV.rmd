---
title: Documentation of the GScstLV tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that sets a variable at constant place in body.


Arg : nothing
Output : code of the 'GScstLV' amino acid
...
*write amino acid GSET, 1, 1, 0, addr, var, 0*
...
instruction::MARKER, 0, 12001, 0, 0, 0, 0,
