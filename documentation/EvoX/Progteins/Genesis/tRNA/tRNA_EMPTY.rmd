---
title: Documentation of the empty place tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA to find an empty place


Arg : nothing
Output : code of the 'EMPTY' amino acid
...
*write amino acid EMPTY, 1, 1, 0, var, var, 0*
id_tRNA_MInstr, instruction::EMPTY
id_tRNA_M1
id_tRNA_M1
id_tRNA_M0
id_tRNA_MLV
