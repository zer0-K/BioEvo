---
title: Documentation of the GScstcst tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that sets a constant value at constant place in body.


Arg : nothing
Output : code of the 'GScstcst' amino acid
...
*write amino acid GSET, 1, 0, 0, addr, cst, 0*
id_tRNA_MInstr, instruction::GSET
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
id_tRNA_Marg
...
instruction::MARKER, 0, 12000, 0, 0, 0, 0,
