---
title: Documentation of the USLV tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that gets the universe size.


Arg : nothing
Output : code of the 'USLV' amino acid
...
*write amino acid CPYUS, 1, 0, 0, var, 0, 0*
id_tRNA_MInstr, instruction::CPYUS
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
id_tRNA_MLV
...
instruction::MARKER, 0, 13000, 0, 0, 0, 0,
