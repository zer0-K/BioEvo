--- 
title: Documentation of the uniform random tRNA (LV-cst)
output: 
  html_document:
    code_folding: hide
---
...
Arg : nothing
Output : code of the 'RUILVcst' amino acid
...
*write amino acid RUI, 1, 1, 0, var, var, cst*
