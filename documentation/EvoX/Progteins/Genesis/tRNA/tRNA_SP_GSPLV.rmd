---
title: Documentation of the stack ptr getter special tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA getting the stack ptr into a local variable.
The transcribed amino acid gets stack ptr into a local var
...
Writes the instruction CPY, 1, 1, 0, v1, 99, 0 at the E site
```
...
*write amino acid CPY, 1, 1, 0, v1, 99, 0*
id_tRNA_MCPY
id_tRNA_M1
id_tRNA_M1
id_tRNA_M0
...
instruction::MARKER, 0, 15003, 0, 0, 0, 0,
