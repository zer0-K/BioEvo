---
title: Documentation of the copy instruction meta tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the meta RNA for CPY instruction.


Arg : nothing
Output : code of the 'meta CPY' amino acid
...
* INC, 2, 0, 0, 101, 0, 0
* CPY, 3, 0, 0, 101, instruction::CPY, 0
at the E site
```
...
*write amino acid CPY, 3, 0, 0, 101, instruction::CPY, 0*
id_tRNA_MCPY
id_tRNA_M3
id_tRNA_M0
id_tRNA_M0
...
instruction::MARKER, 0, 14201, 0, 0, 0, 0,
