---
title: Documentation of the GISLV tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that gets input size in local var.


Arg : nothing
Output : code of the 'GISLV' amino acid
...
*write amino acid CPYIS, 1, 0, 0, var, 0, 0*
id_tRNA_MInstr, instruction::CPYIS
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
id_tRNA_MLV
...
instruction::MARKER, 0, 11010, 0, 0, 0, 0,
