---
title: Documentation of the PCSI tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that puts a constant value on the stack with increment.


Arg : nothing
Output : code of the 'PCSI' amino acid
...
*write amino acid CPY, 2, 0, 0, 99, cst, 0*
id_tRNA_MCPY
id_tRNA_M2
id_tRNA_M0
id_tRNA_M0
...
instruction::MARKER, 0, 11100, 0, 0, 0, 0,
