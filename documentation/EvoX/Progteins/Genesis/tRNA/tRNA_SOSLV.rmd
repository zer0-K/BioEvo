---
title: Documentation of the SOSLV tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that sets output size with value in a variable.


Arg : nothing
Output : code of the 'SOSLV' amino acid
...
*write amino acid SETOS, 1, 0, 0, var, 0, 0*
id_tRNA_MInstr, instruction::SETOS
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
id_tRNA_MLV
...
instruction::MARKER, 0, 11001, 0, 0, 0, 0,
