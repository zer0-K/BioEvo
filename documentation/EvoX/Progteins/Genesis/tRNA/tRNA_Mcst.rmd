---
title: Documentation of the constant meta tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the meta RNA to put a constant value.
In a way an instruction I, D1, D2, D3, V1, V2, V3 can be constructed with 7 cst tRNAs, 
each one writing I, D1, D2, D3, V1, V2, V3.


Arg : nothing
Output : code of the 'meta constant' amino acid
...
101, id_tRNA_Marg, id_tRNA_M0, id_tRNA_RET, GSTOP_ID, 0, 0,
```
...
*write amino acid CPY, 3, 0, 0, 101, cst, 0*
id_tRNA_MCPY
id_tRNA_M3
id_tRNA_M0
id_tRNA_M0
...
instruction::MARKER, 0, 14100, 0, 0, 0, 0,
