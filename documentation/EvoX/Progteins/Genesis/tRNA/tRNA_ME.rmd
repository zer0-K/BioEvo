---
title: Documentation of the E-site meta tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the meta RNA for the E-site.
The E-site is the exit ptr, where the amino acids are being built.


Arg : nothing
Output : code of the 'E-site' amino acid
...
*write amino acid DEC, 1, 0, 0, 99, 0, 0*
id_tRNA_MInstr, instruction::DEC
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
id_tRNA_Mcst, 99 
...
*write amino acid CPY, 1, 2, 0, 101, 99, 0*
id_tRNA_MCPY
id_tRNA_M1
id_tRNA_M2
id_tRNA_M0
...
*write amino acid INC, 1, 0, 0, 99, 0, 0*
...
*write amino acid INC, 1, 0, 0, 101, 0, 0*
id_tRNA_MInstr, instruction::INC
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
...
instruction::MARKER, 0, 14010, 0, 0, 0, 0,
