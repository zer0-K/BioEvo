---
title: Documentation of the fct ptr getter special tRNA
output: 
  html_document:
    code_folding: hide
---
...
Arg : nothing
Output : code of the 'SP_GFPTRLV' amino acid
...
Writes the instruction CPY, 1, 2, 0, v1, 0, 0 at the E site
```
...
*write amino acid CPY, 1, 2, 0, v1, 0, 0*
id_tRNA_MCPY
id_tRNA_M1
id_tRNA_M2
id_tRNA_M0
...
instruction::MARKER, 0, 15002, 0, 0, 0, 0,
