---
title: Documentation of the RULV tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that reads in input the universe cell at local var.


Arg : nothing
Output : code of the 'RULV' amino acid
...
id_tRNA_M0, id_tRNA_M0, id_tRNA_RET, GSTOP_ID, 0, 0, 0, 0,
```
...
*write amino acid READ, 1, 0, 0, var, 0, 0*
id_tRNA_MInstr, instruction::READ
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
id_tRNA_MLV
...
instruction::MARKER, 0, 13001, 0, 0, 0, 0,
