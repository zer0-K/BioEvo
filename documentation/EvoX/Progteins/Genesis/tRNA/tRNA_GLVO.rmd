...
Goal : This tRNA transcribes the RNA copies a variable into output.
...
id_tRNA_MLV, 99, id_tRNA_M0, id_tRNA_RET, GSTOP_ID, 0, 0, 0,
```
...
*write amino acid CPYOUT, 1, 1, 0, addr, var, 0*
