---
title: Documentation of the GLVO tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA copies a variable into output (outpout index is in a variable).


Arg : nothing
Output : code of the 'GLVO' amino acid
...
*write amino acid CPYOUT, 2, 1, 0, var addr, var, 0*
id_tRNA_MInstr, instruction::CPYOUT
id_tRNA_M2
id_tRNA_M1
id_tRNA_M0
id_tRNA_MLV, 
...
instruction::MARKER, 0, 10250, 0, 0, 0, 0,
