---
title: Documentation of the CALLcst tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that calls a function with given ID.


Arg : nothing
Output : code of the 'CALLcst' amino acid
...
*write amino acid CALL, 0, 0, 0, 0, cst, 0*
...
instruction::MARKER, 0, 11500, 0, 0, 0, 0,
