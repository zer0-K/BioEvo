---
title: Documentation of the SDLVcst tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that copies a cst to a dereferenced variable.


Arg : nothing
Output : code of the 'SDLVcst' amino acid
...
*write amino acid CPY, 2, 0, 0, var, cst, 0*
id_tRNA_MCPY
id_tRNA_M2
id_tRNA_M0
id_tRNA_M0
...
instruction::MARKER, 0, 10101, 0, 0, 0, 0,
