---
title: Documentation of the ScstLV tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that writes a var in a constant address.


Arg : nothing
Output : code of the 'ScstLV' amino acid
...
*write amino acid CPY, 1, 1, 0, addr, var, 0*
id_tRNA_MCPY
id_tRNA_M1
id_tRNA_M1
id_tRNA_M0
...
instruction::MARKER, 0, 10114, 0, 0, 0, 0,
