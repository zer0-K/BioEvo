---
title: Documentation of the uniform random tRNA (cst-cst)
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that generates a random int between two constant bounds.


Arg : nothing
Output : code of the 'RUIcstcst' amino acid
...
*write amino acid RUI, 1, 0, 0, var, cst, cst*
