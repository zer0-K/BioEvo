---
title: Documentation of the GADD tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that add a constant value in the DNA at the pos specified by the variable.


Arg : nothing
Output : code of the 'GADD' amino acid
...
*write amino acid GADD, 1, 0, 0, var, cst, 0*
id_tRNA_MInstr, instruction::GADD
id_tRNA_M1
id_tRNA_M0
id_tRNA_M0
id_tRNA_MLV
...
instruction::MARKER, 0, 12500, 0, 0, 0, 0,
...
instruction::CPY, 3, 0, 0, 101, instruction::GADD, 0,
