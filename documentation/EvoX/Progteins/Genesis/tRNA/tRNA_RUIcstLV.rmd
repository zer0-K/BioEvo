---
title: Documentation of the uniform random tRNA (cst-var)
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that generates a random int between a constant and a variable bounds.


Arg : nothing
Output : code of the 'RUIcstLV' amino acid
...
*write amino acid RUI, 1, 0, 1, var, cst, var*
