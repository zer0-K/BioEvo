---
title: Documentation of the genetic copy special tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA of a GCPY instruction
The transcribed amino acid copies values between args in the phenotypic body at the place specified byt the first arg.


Arg : nothing
Output : code of the 'SP_GCPY' amino acid
...
Writes the instruction GCPY, 2, 2, 2, v1, v2, v3 at the E site
```
...
*write amino acid GCPY, 2, 2, 2, v1, v2, v3*
...
instruction::MARKER, 0, 15004, 0, 0, 0, 0,
