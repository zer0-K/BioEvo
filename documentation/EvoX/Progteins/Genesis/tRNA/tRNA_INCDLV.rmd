---
title: Documentation of the INCDLV tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the RNA that increment/decrement at dereferenced local var.


Arg : nothing
Output : code of the 'INCDLV' amino acid
...
*write amino acid INC/DEC, 2, 0, 0, v1, 0, 0*
id_tRNA_INCDLV, 0, 2
id_tRNA_SLVDLV, 4, 2
id_tRNA_SDLVLV, 4, 3
id_tRNA_M2
...
instruction::MARKER, 0, 11452, 0, 0, 0, 0,
