---
title: Documentation of the OPELVcst tRNA
output: 
  html_document:
    code_folding: hide
---
...
Goal : This tRNA transcribes the meta RNA for in-place operations of variable with constant.
For example, this tRNA can transcribe for var+=4.


Arg : nothing
Output : code of the 'OPELVcst' amino acid
...
instruction::MARKER, 0, 11402, 0, 0, 0, 0,
