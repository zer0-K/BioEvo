...
*mutate code*
id_tRNA_SLVcst, 3, 1                // var3 <- 1
id_tRNA_INCLV, 0, 1                 // var1++ : skip func ID
id_tRNA_IF0, 3
| id_tRNA_RGLVLV, 2, 1                          // var2 <- body val at var1
| id_tRNA_OPELVcst, 1, 2, id_begin_mutators     // var2 -= mutator_ids
| id_tRNA_CMPLVcst, 2, 2, 0, 3                  // var3 <- var 2 > 0 ?
| id_tRNA_CMPLVcst, 1, 2, 10000, 4              // var4 <- var 2 < 10000 ?
| id_tRNA_OPELVLV, 2, 3, 4                      // var3 *= var4 (1 if mut <= var4 < mut+10k)
| id_tRNA_OPELVcst, 0, 2, id_begin_mutators     // var2 += mutator_ids (shift back)
| id_tRNA_IF0, 3                                // mutator found
| |
| | *put DNA ptr and shift onto the stack*
| | id_tRNA_PLVSI, 7               // put var7 at TOPS
| | id_tRNA_PLVSI, 1               // put var1 at TOPS
| | 
| | *call mutator*
| | id_tRNA_CALLLV, 2                   // call mutator
| | 
| | *get DNA ptr and shift from stack*
| | id_tRNA_GTSLVD, 1                   // var1 <- TOPS  (p)
| | id_tRNA_GTSLVD, 7                   // var7 <- TOPS  (p)
| |
| id_tRNA_SIJ
| id_tRNA_SEJ
|
| id_tRNA_SLVcst, 5, GSTOP_ID-1
| id_tRNA_INCLV, 0, 5             // var5 <- GSTOP_ID
| id_tRNA_INCLV, 0, 1             // var1++
| id_tRNA_RGLVLV, 2, 1            // var2 <- body val at var1
| id_tRNA_CMPLVLV, 0, 2, 5, 3     // var3 <- var2==GSTOP_ID (var5)
| id_tRNA_INCLV, 1, 3             // var3--
id_tRNA_SWJ
