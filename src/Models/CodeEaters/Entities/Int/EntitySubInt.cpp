#include "EntitySubInt.hpp"

#include "../../../../Utils/Constants.hpp"

void EntitySubInt::init()
{
...
/**
 * @brief substraction with 3 code eaters, the first one is the result
*/
std::vector<sp_entity> EntitySubInt::exec(std::vector<sp_entity> entries)
{
    if(entries.size() == 3)
    {
