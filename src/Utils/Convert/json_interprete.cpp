...
#include "../../Experiments/Experiment_1_00/Individuals/LinearRegressionIndividual.hpp"
...
std::string set_individuals(Framework* framework, boost::json::object* params)
{
    ...
    if(jname_universe != nullptr && jnb_individuals !=nullptr && jindividuals != nullptr)
    {
        ...
        for(int i=0;i<nb_individuals;i++)
        {
            ...
            individuals[i] = (Individual*) new LinearRegressionIndividual(name_individual, dimension_individual);
        }
