...
{
    sp_evox algo = get_algo();

    FreeGenesFunctionRead(algo);
}

sp_evox GeneticFunctionAcquisition::get_algo()
{
...
std::vector<int> GeneticFunctionAcquisition::get_genes_function_write()
{
    return {
        ...
        3, 1,
        // TODO (for the moment, only increment arg on stack)
        instruction::INC, 2, 0, 0, 99, 0, 0,
    };
}

void GeneticFunctionAcquisition::FreeGenesFunctionRead(sp_evox algo)
{
