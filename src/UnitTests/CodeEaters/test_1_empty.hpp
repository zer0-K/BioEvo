...
*/
bool launch_test_code_eaters_empty()
{
    sp_univ_code_eaters build_empty_universe_code_eaters(int);    
    ...
    for(int i=0; i<sizes.size(); i++)
    {
        ...
        sp_univ_code_eaters universe_code_eaters = build_empty_universe_code_eaters(size_universe);
    ...
    std::cout << "\tUnit test empty code eaters universe : ";
    if(is_passed)
        std::cout << greencol << "passed" << defcol;
    else
        std::cout << redcol << "not passed" << defcol;
...
*/
sp_univ_code_eaters build_empty_universe_code_eaters(int size_universe)
{
