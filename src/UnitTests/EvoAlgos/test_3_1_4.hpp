    ...
    bool test_evo_algos_evox_phenotypic_body_exec_simple()
    {
        ...
        for(int i=0; i<expected_outs.size(); i++)
        {
            ...
            for(int j=0; j<expected_outs[i].size(); j++)
            {
                ...
                {
                    std::cout << "Evo algos - evox - phenotypic body - exec - simple "
                              << i << " - " << j << ": ";
            ...
            if(verbose_unit_tests_1)
            {
                std::cout << "Evo algos - evox - phenotypic body - exec - simple " << i << " : ";
    ...
    bool test_evo_algos_evox_phenotypic_body_exec_JMP01call()
    {
        ...
        for(int i=0; i<expected_outs.size(); i++)
        {
            ...
            for(int j=0; j<expected_outs[i].size(); j++)
            {
                ...
                if(verbose_unit_tests_1)
                {
                    std::cout << "Evo algos - evox - phenotypic body - exec - JMP01 call "
                              << i << " - " << j << ": ";
                    passed_print(is_passed_i_j);
                } 
            }
            ...
            if(verbose_unit_tests_1)
            {
                std::cout << "Evo algos - evox - phenotypic body - exec - JMP01 call " << i << " : ";
                passed_print(is_passed_i);
            } 
       }
