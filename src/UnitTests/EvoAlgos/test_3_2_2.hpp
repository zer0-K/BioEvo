...
Teleonomical IDs :
    ...
    - 200-299 : internal utility funcs (phenotypic body size, copy input as func, func pos,...)
...
namespace ut_ea
{
    ...
    sp_evox get_evox_algo_evolution_preliminaries_autopoiesis()
    {
        ...
        // base phenotypic body for an autonomical genesis
        // teleonomical IDs:
        //      - -100- : genetic data
        //      - -1 : phenotypic body end
        //      - 0-99 : core functions (meta-exec func, main, core switcher, teleonomical list builder,...)
        ...
        //----- first autopoiesis phase
            ...
            // data stack stuff
            instruction::GR, 1, 1, 0, 100, 3, 0,    // stack pos is at 3rd pos in phenotypic body
        ...
        //----- second autopoiesis phase
            ...
            // find phenotypic molecules for top of list
        ...
        //----- copy input (free molecules) into code as new func
            ...
            instruction::CPY, 1, 0, 0, 102, 1, 0,       // beginning of phenotypic molecules to copy in input
            ...
            instruction::CPYIS, 1, 0, 0, 105, 0, 0,
                ...
                instruction::CPY, 2, 1, 0, 104, 101, 0,
                instruction::ADD, 1, 1, 0, 104, 104, 4,
            // copy data into phenotypic bodybefore ending marker
